...
legend.setAttribute("style", "background-color:gold");
...
const racine = document.createElement('input');
racine.innerText = "√";
racine.setAttribute("type", "button");
racine.setAttribute("value", "√");
...
réinitialiser.setAttribute("value", "C");
...
opérateurs.appendChild(racine);
opérateurs.appendChild(égalité);

field.appendChild(réinitialiser);
field.appendChild(réponse);
